/*Notes :
-> using a pair < pair <int, int> , int> to store the start, end and positon of given data
-> sort that data according to a compare function u gonna have to make.
-> acc to ques the start time of the second meeting should not be less or equal to prev meeting so according to that run loop and do res++
-> return res
*/
